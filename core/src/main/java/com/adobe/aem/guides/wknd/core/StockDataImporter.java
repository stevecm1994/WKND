...
import com.adobe.aem.guides.wknd.core.utils.ParseJson;
...
private final String SOURCE_URL = "https://query1.finance.yahoo.com/v7/finance/quote?symbols=";
	...
	@Override
	public void importData(String scheme, final String dataSource, final Resource resource) throws ImportException {
		try {
			ParseJson parseJson = new ParseJson();
			String lastTrade = parseJson.loadJson(SOURCE_URL+dataSource);
			logger.info("Last Trade Value from api = " + lastTrade);
